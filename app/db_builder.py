...
db.query("CREATE TABLE IF NOT EXISTS comments (comment TEXT, user_id INTEGER, user_pfp TEXT, user_name TEXT, project_id INTEGER, upvotes INTEGER, downvotes INTEGER, anonymous INTEGER);")
