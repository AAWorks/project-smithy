...
db.query("CREATE TABLE IF NOT EXISTS comments (comment_id INTEGER PRIMARY KEY AUTOINCREMENT, comment TEXT, user_id INTEGER, user_pfp TEXT, user_name TEXT, project_id INTEGER, upvotes INTEGER anonymous INTEGER);")
